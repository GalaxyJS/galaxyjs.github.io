(function () {
  ...
  (function () {
    ...
    function oa (a, b) {v ? a.setAttribute("class", b) : window.ShadyDOM.nativeMethods.setAttribute.call(a, "class", b)}
    ...
    (function (a) {
      ...
      k.prototype.u = function (a, b) {
        ...
        w &&
        (a = a.replace(v, function (a, b, c) {return -1 === a.indexOf("type=") ? b + " type=import-disable " + c : a}));
    ...
    k.prototype.f = function () {
      ...
      this.a.enqueued &&
      (C ? this.Wa(a) : (this.v(this.g, this.h), this.M(a)), this.a.enqueued = !1, this.i && !C && this.styleDocument())
    };
...
(function () {
  ...
  var g = window, _ = document,
    ...
    w = Element.prototype.createShadowRoot, A = _.createElement("div"), x = function () {}, C = function () {return !0},
  ...
  var Y = /\/\*!?(?:\@preserve)?[ \t]*(?:\r\n|\n)([\s\S]*?)(?:\r\n|\n)\s*\*\//, B = {
    ...
    addClass: function (t, e) {
      ...
      return e.trim().split(" ").forEach(function (t) {~n.indexOf(t) || n.push(t)}), t.className = n.join(" ").trim(), t
    },
    removeClass: function (t, e) {
      var n = e.trim().split(" ");
      return t.className = t.className.trim().split(" ").filter(function (t) {return t && !~n.indexOf(t)}).join(" "), t
    },
